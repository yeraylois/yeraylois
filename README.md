...
- 🎓 **Degree**: B.Sc. in Computer Engineering @ UDC (Hardware & Computation)  
- 🔬 **Embedded Systems**: Real-time firmware in C/Assembly, microcontroller optimization  
- 🌐 **Full-Stack**: Angular, Java/Kotlin, Python, RESTful API development  
- 🏆 **Hack UDC 2025**: Contributed “SolutionHub” — Gradiant Challenge Winner  
- 🚀 **HackUPC 2025**: Built the [SkyBuddies](https://github.com/DiegoRS05/SkyBuddies) travel planning app  
...
<p align="center">
  <picture>
    ...
    <img alt="GitHub Contribution Grid Snake Animation" src="https://raw.githubusercontent.com/yeraylois/yeraylois/output/github-contribution-grid-snake.svg" width="100%"/>
  </picture>
</p>
